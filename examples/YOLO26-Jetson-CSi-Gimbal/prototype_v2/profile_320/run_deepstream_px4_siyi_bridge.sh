...
PAN_GAIN="${PAN_GAIN:-0.85}"
TILT_GAIN="${TILT_GAIN:-0.80}"
DEADZONE="${DEADZONE:-0.05}"
SMOOTH_ALPHA="${SMOOTH_ALPHA:-0.40}"
FAST_SMOOTH_ALPHA="${FAST_SMOOTH_ALPHA:-0.75}"
FAST_ERROR_ZONE="${FAST_ERROR_ZONE:-0.18}"
COMMAND_BOOST_ZONE="${COMMAND_BOOST_ZONE:-0.10}"
MIN_ACTIVE_COMMAND="${MIN_ACTIVE_COMMAND:-0.18}"
RESPONSE_GAMMA="${RESPONSE_GAMMA:-0.65}"
