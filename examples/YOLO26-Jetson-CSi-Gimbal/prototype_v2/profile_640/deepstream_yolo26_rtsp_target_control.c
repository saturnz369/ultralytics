...
load_config(AppConfig *cfg)
{
  ...
  cfg->infer_config = env_strdup_default(
      "INFER_CONFIG",
      "/home/aarl/ultralytics/examples/YOLO26-Jetson-CSi-Gimbal/prototype_v2/profile_640/config/config_infer_primary_yolo26.txt");
  cfg->tracker_config = env_strdup_default(
      "TRACKER_CONFIG",
      "/home/aarl/ultralytics/examples/YOLO26-Jetson-CSi-Gimbal/prototype_v2/profile_640/config/tracker_config.txt");
  cfg->state_file = env_strdup_default(
      "STATE_FILE",
      "/tmp/profile640_deepstream_yolo26_target_control.jsonl");
}
